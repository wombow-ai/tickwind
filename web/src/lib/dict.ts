...
export const dict: Record<Lang, Record<string, string>> = {
  en: {
    ...
    'deep.gate.body': 'A deeper, source-attributed analyst report for {t} — multi-section valuation, fundamentals, technicals, smart-money and sentiment, every number drawn from public data. Free for logged-in members (1 report/day).',
    ...
    'deep.quota.title': 'Daily deep-research limit reached',
    'deep.quota.body': "You've used today's deep-research generation (1/day). Try again tomorrow, or open a stock whose report was already generated today (those are free).",
  ...
  zh: {
    ...
    'deep.gate.body': '{t} 的更深度、来源可溯的分析师研报 —— 涵盖估值 / 基本面 / 技术 / 资金面 / 情绪面多个板块,每个数字均来自公开数据。登录会员免费(每日 1 篇)。',
    'deep.gate.cta': '登录以继续',
    'deep.gate.preview': '预览',
    'deep.gate.previewNote': '以下为公开研报预览 —— 登录查看完整深度研报。',
    'deep.quota.title': '今日深度研报已用完',
    'deep.quota.body': '您已用完今日的深度研报生成额度(每日 1 篇)。请明天再试,或打开今日已生成研报的股票(已生成的研报免费)。',
