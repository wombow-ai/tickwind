...
func main() {
	...
	if bars != nil {
		...
		apiServer.SetChatFreeWeeklyTokens(cfg.ChatFreeWeeklyTokens)
		log.Info("personalized chat enabled", "chat_model", cfg.LLMChatModel, "chat_monthly_limit", cfg.ChatMonthlyLimit, "chat_monthly_token_limit", cfg.ChatMonthlyTokenLimit, "chat_free_weekly_tokens", cfg.ChatFreeWeeklyTokens, "web_search", webClient.Enabled())
	} else {
